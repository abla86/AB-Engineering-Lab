class ContainerProberEngine {
  ...
  probe() {
    ...
    if (!this.healthy) {
      ...
      this.sendTelemetry({ liveness: "FAILED", readiness: "NOT READY", restarts: this.restarts, mode: "DEMONSTRATOR" });
      return;
    }
    ...
    this.sendTelemetry({ liveness: "PASSED", readiness: "READY", restarts: this.restarts, mode: "DEMONSTRATOR" });
  }
...
if (typeof window !== "undefined") window.ContainerProberEngine = ContainerProberEngine;

export { ContainerProberEngine };
