...
The audited period contains CI, security-lab, navigation and documentation changes. This audit records the repository state without retroactively assuming that every change was authorised.
