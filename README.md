...
A runnable polyglot event-driven platform demonstrating TypeScript/Node, C#/.NET, Python, Java, Kotlin and Go through service/consumer boundaries, with PostgreSQL, Kafka, Docker, Kubernetes and automated tests.

Path: `projects/eventforge`

### SecureDotNet

A focused ASP.NET Core security reference implementation demonstrating C#, .NET 10, authentication, authorization, protected application data and RSA digital signatures without committing credentials.

Path: `projects/secure-dotnet`
...
See [`docs/ROLE-SKILL-MATRIX.md`](docs/ROLE-SKILL-MATRIX.md) for an evidence-first mapping from the software-engineering/full-stack requirements reviewed in September 2026 to concrete repositories and implementations.

The matrix deliberately distinguishes **implemented**, **demonstrated**, and **gap**. Technology names are not counted as evidence unless executable code, tests or a verifiable implementation path exists.
...
│   ├── secure-dotnet/          ASP.NET Core security reference
